...
INSERT INTO creature(id, ac, alignment, cost, fort, hp, level, movementMode, name, ref, speed, will, factions, championRating, setInfo) VALUES (2, 20, 'NEUTRAL', 20, 16, 17, 5, 'NORMAL', 'Warforged scout 1', 19, 8, 20, 'CIVILIZATION', 0, 'Set one');
...
INSERT INTO warband_creature(id, warband_id, creature_id, position) VALUES (1, 1, 1, null);
INSERT INTO warband_creature(id, warband_id, creature_id, position) VALUES (2, 1, 2, 2);
INSERT INTO warband_creature(id, warband_id, creature_id, position) VALUES (3, 1, 3, 1);
